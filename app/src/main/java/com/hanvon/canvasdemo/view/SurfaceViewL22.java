...
public class SurfaceViewL22 extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public SurfaceViewL22(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public SurfaceViewL22(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
